...
def main():
    ...
    src_file = os.path.join(directory, "RunIII2024Summer24_V2_MC_L2Relative_AK4PUPPI.txt")
    if not os.path.isfile(src_file):
        print(f"Source file not found: {src_file}")
        return

    # Pattern for files that indicate an L2L3Residual correction for DATA
    pattern = os.path.join(directory, "ReReco24_*_DATA_L2L3Residual_AK4PFPuppi.txt")
