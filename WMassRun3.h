...
// Mon Dec 16 11:34:05 2024 by ROOT version 6.32.08
// from TTree Events/Events
// found on file: 090b75df-297c-43a4-8178-5cbfd06387bc.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nboostedTau;
   UChar_t         boostedTau_idAntiEle2018[200];   //[nboostedTau]
   UChar_t         boostedTau_idAntiMu[200];   //[nboostedTau]
   UChar_t         boostedTau_idMVAnewDM2017v2[200];   //[nboostedTau]
   UChar_t         boostedTau_idMVAoldDM2017v2[200];   //[nboostedTau]
   Short_t         boostedTau_jetIdx[200];   //[nboostedTau]
   Short_t         boostedTau_rawAntiEleCat2018[200];   //[nboostedTau]
   Int_t           boostedTau_charge[200];   //[nboostedTau]
   Int_t           boostedTau_decayMode[200];   //[nboostedTau]
   Float_t         boostedTau_chargedIso[200];   //[nboostedTau]
   Float_t         boostedTau_eta[200];   //[nboostedTau]
   Float_t         boostedTau_leadTkDeltaEta[200];   //[nboostedTau]
   Float_t         boostedTau_leadTkDeltaPhi[200];   //[nboostedTau]
   Float_t         boostedTau_leadTkPtOverTauPt[200];   //[nboostedTau]
   Float_t         boostedTau_mass[200];   //[nboostedTau]
   Float_t         boostedTau_neutralIso[200];   //[nboostedTau]
   Float_t         boostedTau_phi[200];   //[nboostedTau]
   Float_t         boostedTau_photonsOutsideSignalCone[200];   //[nboostedTau]
   Float_t         boostedTau_pt[200];   //[nboostedTau]
   Float_t         boostedTau_puCorr[200];   //[nboostedTau]
   Float_t         boostedTau_rawAntiEle2018[200];   //[nboostedTau]
   Float_t         boostedTau_rawIso[200];   //[nboostedTau]
   Float_t         boostedTau_rawIsodR03[200];   //[nboostedTau]
   Float_t         boostedTau_rawMVAnewDM2017v2[200];   //[nboostedTau]
   Float_t         boostedTau_rawMVAoldDM2017v2[200];   //[nboostedTau]
   Float_t         CaloMET_phi;
   Float_t         CaloMET_pt;
   Float_t         CaloMET_sumEt;
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_EmEF[200];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_area[200];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[200];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[200];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[200];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[200];   //[nCorrT1METJet]
   ...
   Int_t           nElectron;
   Bool_t          Electron_convVeto[200];   //[nElectron]
   UChar_t         Electron_cutBased[200];   //[nElectron]
   Bool_t          Electron_cutBased_HEEP[200];   //[nElectron]
   Bool_t          Electron_isEB[200];   //[nElectron]
   Bool_t          Electron_isEcalDriven[200];   //[nElectron]
   Bool_t          Electron_isPFcand[200];   //[nElectron]
   UChar_t         Electron_jetNDauCharged[200];   //[nElectron]
   UChar_t         Electron_lostHits[200];   //[nElectron]
   Bool_t          Electron_mvaIso_WP80[200];   //[nElectron]
   Bool_t          Electron_mvaIso_WP90[200];   //[nElectron]
   Bool_t          Electron_mvaIso_WPHZZ[200];   //[nElectron]
   Bool_t          Electron_mvaNoIso_WP80[200];   //[nElectron]
   Bool_t          Electron_mvaNoIso_WP90[200];   //[nElectron]
   UChar_t         Electron_seedGain[200];   //[nElectron]
   UChar_t         Electron_tightCharge[200];   //[nElectron]
   Short_t         Electron_jetIdx[200];   //[nElectron]
   Short_t         Electron_photonIdx[200];   //[nElectron]
   Short_t         Electron_seediEtaOriX[200];   //[nElectron]
   Short_t         Electron_seediPhiOriY[200];   //[nElectron]
   Short_t         Electron_svIdx[200];   //[nElectron]
   Short_t         Electron_fsrPhotonIdx[200];   //[nElectron]
   Int_t           Electron_charge[200];   //[nElectron]
   Int_t           Electron_pdgId[200];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmap[200];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapHEEP[200];   //[nElectron]
   Float_t         Electron_PreshowerEnergy[200];   //[nElectron]
   Float_t         Electron_deltaEtaSC[200];   //[nElectron]
   Float_t         Electron_dr03EcalRecHitSumEt[200];   //[nElectron]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[200];   //[nElectron]
   Float_t         Electron_dr03TkSumPt[200];   //[nElectron]
   Float_t         Electron_dr03TkSumPtHEEP[200];   //[nElectron]
   Float_t         Electron_dxy[200];   //[nElectron]
   Float_t         Electron_dxyErr[200];   //[nElectron]
   Float_t         Electron_dz[200];   //[nElectron]
   Float_t         Electron_dzErr[200];   //[nElectron]
   Float_t         Electron_eInvMinusPInv[200];   //[nElectron]
   Float_t         Electron_ecalEnergy[200];   //[nElectron]
   Float_t         Electron_ecalEnergyError[200];   //[nElectron]
   Float_t         Electron_energyErr[200];   //[nElectron]
   Float_t         Electron_eta[200];   //[nElectron]
   Float_t         Electron_fbrem[200];   //[nElectron]
   Float_t         Electron_gsfTrketaMode[200];   //[nElectron]
   Float_t         Electron_gsfTrkpMode[200];   //[nElectron]
   Float_t         Electron_gsfTrkpModeErr[200];   //[nElectron]
   Float_t         Electron_gsfTrkphiMode[200];   //[nElectron]
   Float_t         Electron_hoe[200];   //[nElectron]
   Float_t         Electron_ip3d[200];   //[nElectron]
   Float_t         Electron_jetPtRelv2[200];   //[nElectron]
   Float_t         Electron_jetRelIso[200];   //[nElectron]
   Float_t         Electron_mass[200];   //[nElectron]
   Float_t         Electron_miniPFRelIso_all[200];   //[nElectron]
   Float_t         Electron_miniPFRelIso_chg[200];   //[nElectron]
   Float_t         Electron_mvaHZZIso[200];   //[nElectron]
   Float_t         Electron_mvaIso[200];   //[nElectron]
   Float_t         Electron_mvaNoIso[200];   //[nElectron]
   Float_t         Electron_pfRelIso03_all[200];   //[nElectron]
   Float_t         Electron_pfRelIso03_chg[200];   //[nElectron]
   Float_t         Electron_phi[200];   //[nElectron]
   Float_t         Electron_pt[200];   //[nElectron]
   Float_t         Electron_r9[200];   //[nElectron]
   Float_t         Electron_rawEnergy[200];   //[nElectron]
   Float_t         Electron_scEtOverPt[200];   //[nElectron]
   Float_t         Electron_sieie[200];   //[nElectron]
   Float_t         Electron_sip3d[200];   //[nElectron]
   Float_t         Electron_promptMVA[200];   //[nElectron]
   Int_t           nFatJet;
   UChar_t         FatJet_jetId[200];   //[nFatJet]
   UChar_t         FatJet_nConstituents[200];   //[nFatJet]
   Short_t         FatJet_chMultiplicity[200];   //[nFatJet]
   Short_t         FatJet_neMultiplicity[200];   //[nFatJet]
   Short_t         FatJet_subJetIdx1[200];   //[nFatJet]
   Short_t         FatJet_subJetIdx2[200];   //[nFatJet]
   Short_t         FatJet_electronIdx3SJ[200];   //[nFatJet]
   Short_t         FatJet_muonIdx3SJ[200];   //[nFatJet]
   Float_t         FatJet_area[200];   //[nFatJet]
   Float_t         FatJet_chEmEF[200];   //[nFatJet]
   Float_t         FatJet_chHEF[200];   //[nFatJet]
   Float_t         FatJet_eta[200];   //[nFatJet]
   Float_t         FatJet_mass[200];   //[nFatJet]
   Float_t         FatJet_msoftdrop[200];   //[nFatJet]
   Float_t         FatJet_muEF[200];   //[nFatJet]
   Float_t         FatJet_n2b1[200];   //[nFatJet]
   Float_t         FatJet_n3b1[200];   //[nFatJet]
   Float_t         FatJet_neEmEF[200];   //[nFatJet]
   Float_t         FatJet_neHEF[200];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_QCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xbb[200];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xcc[200];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xqq[200];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_mass[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_H4qvsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HbbvsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HccvsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_QCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_TvsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_WvsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_ZvsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD0HF[200];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD1HF[200];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD2HF[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XbbVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XccVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XggVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XqqVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XteVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XtmVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_XttVsQCD[200];   //[nFatJet]
   Float_t         FatJet_particleNet_massCorr[200];   //[nFatJet]
   Float_t         FatJet_phi[200];   //[nFatJet]
   Float_t         FatJet_pt[200];   //[nFatJet]
   Float_t         FatJet_rawFactor[200];   //[nFatJet]
   Float_t         FatJet_tau1[200];   //[nFatJet]
   Float_t         FatJet_tau2[200];   //[nFatJet]
   Float_t         FatJet_tau3[200];   //[nFatJet]
   Float_t         FatJet_tau4[200];   //[nFatJet]
   Float_t         FatJet_lsf3[200];   //[nFatJet]
   Int_t           nFsrPhoton;
   Short_t         FsrPhoton_electronIdx[200];   //[nFsrPhoton]
   Short_t         FsrPhoton_muonIdx[200];   //[nFsrPhoton]
   Float_t         FsrPhoton_dROverEt2[200];   //[nFsrPhoton]
   Float_t         FsrPhoton_eta[200];   //[nFsrPhoton]
   Float_t         FsrPhoton_phi[200];   //[nFsrPhoton]
   Float_t         FsrPhoton_pt[200];   //[nFsrPhoton]
   Float_t         FsrPhoton_relIso03[200];   //[nFsrPhoton]
   Int_t           nIsoTrack;
   Bool_t          IsoTrack_isHighPurityTrack[200];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[200];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[200];   //[nIsoTrack]
   Short_t         IsoTrack_charge[200];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[200];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[200];   //[nIsoTrack]
   Float_t         IsoTrack_dxy[200];   //[nIsoTrack]
   Float_t         IsoTrack_dz[200];   //[nIsoTrack]
   Float_t         IsoTrack_eta[200];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[200];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[200];   //[nIsoTrack]
   Float_t         IsoTrack_phi[200];   //[nIsoTrack]
   Float_t         IsoTrack_pt[200];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[200];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[200];   //[nIsoTrack]
   Int_t           nJet;
   ...
   UChar_t         Jet_nSVs[200];   //[nJet]
   UChar_t         Jet_neMultiplicity[200];   //[nJet]
   Short_t         Jet_electronIdx1[200];   //[nJet]
   Short_t         Jet_electronIdx2[200];   //[nJet]
   Short_t         Jet_muonIdx1[200];   //[nJet]
   Short_t         Jet_muonIdx2[200];   //[nJet]
   Short_t         Jet_svIdx1[200];   //[nJet]
   Short_t         Jet_svIdx2[200];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[200];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[200];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[200];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[200];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[200];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorr[200];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorrNeutrino[200];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawRes[200];   //[nJet]
   Float_t         Jet_area[200];   //[nJet]
   Float_t         Jet_btagDeepFlavB[200];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[200];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[200];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[200];   //[nJet]
   Float_t         Jet_btagPNetB[200];   //[nJet]
   Float_t         Jet_btagPNetCvB[200];   //[nJet]
   Float_t         Jet_btagPNetCvL[200];   //[nJet]
   Float_t         Jet_btagPNetCvNotB[200];   //[nJet]
   Float_t         Jet_btagPNetQvG[200];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[200];   //[nJet]
   Float_t         Jet_btagUParTAK4B[200];   //[nJet]
   Float_t         Jet_btagUParTAK4CvB[200];   //[nJet]
   Float_t         Jet_btagUParTAK4CvL[200];   //[nJet]
   Float_t         Jet_btagUParTAK4CvNotB[200];   //[nJet]
   Float_t         Jet_btagUParTAK4QvG[200];   //[nJet]
   Float_t         Jet_btagUParTAK4TauVJet[200];   //[nJet]
   Float_t         Jet_chEmEF[200];   //[nJet]
   Float_t         Jet_chHEF[200];   //[nJet]
   Float_t         Jet_eta[200];   //[nJet]
   Float_t         Jet_hfEmEF[200];   //[nJet]
   Float_t         Jet_hfHEF[200];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[200];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[200];   //[nJet]
   Float_t         Jet_mass[200];   //[nJet]
   Float_t         Jet_muEF[200];   //[nJet]
   Float_t         Jet_muonSubtrFactor[200];   //[nJet]
   Float_t         Jet_neEmEF[200];   //[nJet]
   Float_t         Jet_neHEF[200];   //[nJet]
   Float_t         Jet_phi[200];   //[nJet]
   Float_t         Jet_pt[200];   //[nJet]
   Float_t         Jet_rawFactor[200];   //[nJet]
   Int_t           nL1EG;
   Short_t         L1EG_hwIso[200];   //[nL1EG]
   Short_t         L1EG_bx[200];   //[nL1EG]
   Float_t         L1EG_eta[200];   //[nL1EG]
   Float_t         L1EG_phi[200];   //[nL1EG]
   Float_t         L1EG_pt[200];   //[nL1EG]
   Int_t           nL1EtSum;
   Short_t         L1EtSum_bx[200];   //[nL1EtSum]
   Int_t           L1EtSum_etSumType[200];   //[nL1EtSum]
   Float_t         L1EtSum_phi[200];   //[nL1EtSum]
   Float_t         L1EtSum_pt[200];   //[nL1EtSum]
   Int_t           nL1Jet;
   Short_t         L1Jet_bx[200];   //[nL1Jet]
   Float_t         L1Jet_eta[200];   //[nL1Jet]
   Float_t         L1Jet_phi[200];   //[nL1Jet]
   Float_t         L1Jet_pt[200];   //[nL1Jet]
   Int_t           nL1Mu;
   Short_t         L1Mu_hwCharge[200];   //[nL1Mu]
   Short_t         L1Mu_hwDXY[200];   //[nL1Mu]
   Short_t         L1Mu_bx[200];   //[nL1Mu]
   Int_t           L1Mu_hwQual[200];   //[nL1Mu]
   Float_t         L1Mu_eta[200];   //[nL1Mu]
   Float_t         L1Mu_etaAtVtx[200];   //[nL1Mu]
   Float_t         L1Mu_phi[200];   //[nL1Mu]
   Float_t         L1Mu_phiAtVtx[200];   //[nL1Mu]
   Float_t         L1Mu_pt[200];   //[nL1Mu]
   Float_t         L1Mu_ptUnconstrained[200];   //[nL1Mu]
   Int_t           nL1Tau;
   Short_t         L1Tau_hwIso[200];   //[nL1Tau]
   Short_t         L1Tau_bx[200];   //[nL1Tau]
   Float_t         L1Tau_eta[200];   //[nL1Tau]
   Float_t         L1Tau_phi[200];   //[nL1Tau]
   Float_t         L1Tau_pt[200];   //[nL1Tau]
   Int_t           nLowPtElectron;
   Bool_t          LowPtElectron_convVeto[200];   //[nLowPtElectron]
   UChar_t         LowPtElectron_convWP[200];   //[nLowPtElectron]
   UChar_t         LowPtElectron_lostHits[200];   //[nLowPtElectron]
   Short_t         LowPtElectron_electronIdx[200];   //[nLowPtElectron]
   Short_t         LowPtElectron_photonIdx[200];   //[nLowPtElectron]
   Int_t           LowPtElectron_charge[200];   //[nLowPtElectron]
   Int_t           LowPtElectron_pdgId[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_ID[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_convVtxRadius[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_deltaEtaSC[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxy[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxyErr[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_dz[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_dzErr[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_eInvMinusPInv[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_energyErr[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_eta[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_hoe[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_mass[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_all[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_chg[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_phi[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_pt[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_ptbiased[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_r9[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_scEtOverPt[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_sieie[200];   //[nLowPtElectron]
   Float_t         LowPtElectron_unbiased[200];   //[nLowPtElectron]
   Int_t           nProton_multiRP;
   UChar_t         Proton_multiRP_arm[200];   //[nProton_multiRP]
   Float_t         Proton_multiRP_t[200];   //[nProton_multiRP]
   Float_t         Proton_multiRP_thetaX[200];   //[nProton_multiRP]
   Float_t         Proton_multiRP_thetaY[200];   //[nProton_multiRP]
   Float_t         Proton_multiRP_time[200];   //[nProton_multiRP]
   Float_t         Proton_multiRP_timeUnc[200];   //[nProton_multiRP]
   Float_t         Proton_multiRP_xi[200];   //[nProton_multiRP]
   Int_t           nMuon;
   UChar_t         Muon_highPtId[200];   //[nMuon]
   Bool_t          Muon_highPurity[200];   //[nMuon]
   Bool_t          Muon_inTimeMuon[200];   //[nMuon]
   Bool_t          Muon_isGlobal[200];   //[nMuon]
   Bool_t          Muon_isPFcand[200];   //[nMuon]
   Bool_t          Muon_isStandalone[200];   //[nMuon]
   Bool_t          Muon_isTracker[200];   //[nMuon]
   UChar_t         Muon_jetNDauCharged[200];   //[nMuon]
   Bool_t          Muon_looseId[200];   //[nMuon]
   Bool_t          Muon_mediumId[200];   //[nMuon]
   Bool_t          Muon_mediumPromptId[200];   //[nMuon]
   UChar_t         Muon_miniIsoId[200];   //[nMuon]
   UChar_t         Muon_multiIsoId[200];   //[nMuon]
   UChar_t         Muon_mvaMuID_WP[200];   //[nMuon]
   UChar_t         Muon_nStations[200];   //[nMuon]
   UChar_t         Muon_nTrackerLayers[200];   //[nMuon]
   UChar_t         Muon_pfIsoId[200];   //[nMuon]
   UChar_t         Muon_puppiIsoId[200];   //[nMuon]
   Bool_t          Muon_softId[200];   //[nMuon]
   Bool_t          Muon_softMvaId[200];   //[nMuon]
   UChar_t         Muon_tightCharge[200];   //[nMuon]
   Bool_t          Muon_tightId[200];   //[nMuon]
   UChar_t         Muon_tkIsoId[200];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[200];   //[nMuon]
   Short_t         Muon_jetIdx[200];   //[nMuon]
   Short_t         Muon_svIdx[200];   //[nMuon]
   Short_t         Muon_fsrPhotonIdx[200];   //[nMuon]
   Int_t           Muon_charge[200];   //[nMuon]
   Int_t           Muon_pdgId[200];   //[nMuon]
   Float_t         Muon_dxy[200];   //[nMuon]
   Float_t         Muon_dxyErr[200];   //[nMuon]
   Float_t         Muon_dxybs[200];   //[nMuon]
   Float_t         Muon_dz[200];   //[nMuon]
   Float_t         Muon_dzErr[200];   //[nMuon]
   Float_t         Muon_eta[200];   //[nMuon]
   Float_t         Muon_ip3d[200];   //[nMuon]
   Float_t         Muon_jetPtRelv2[200];   //[nMuon]
   Float_t         Muon_jetRelIso[200];   //[nMuon]
   Float_t         Muon_mass[200];   //[nMuon]
   Float_t         Muon_miniPFRelIso_all[200];   //[nMuon]
   Float_t         Muon_miniPFRelIso_chg[200];   //[nMuon]
   Float_t         Muon_mvaMuID[200];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[200];   //[nMuon]
   Float_t         Muon_pfRelIso03_chg[200];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[200];   //[nMuon]
   Float_t         Muon_phi[200];   //[nMuon]
   Float_t         Muon_pt[200];   //[nMuon]
   Float_t         Muon_ptErr[200];   //[nMuon]
   Float_t         Muon_segmentComp[200];   //[nMuon]
   Float_t         Muon_sip3d[200];   //[nMuon]
   Float_t         Muon_softMva[200];   //[nMuon]
   Float_t         Muon_softMvaRun3[200];   //[nMuon]
   Float_t         Muon_tkRelIso[200];   //[nMuon]
   Float_t         Muon_tunepRelPt[200];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[200];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[200];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[200];   //[nMuon]
   Float_t         Muon_mvaLowPt[200];   //[nMuon]
   Float_t         Muon_promptMVA[200];   //[nMuon]
   Float_t         PFMET_covXX;
   Float_t         PFMET_covXY;
   Float_t         PFMET_covYY;
   Float_t         PFMET_phi;
   ...
   Int_t           nPhoton;
   UChar_t         Photon_cutBased[200];   //[nPhoton]
   Bool_t          Photon_electronVeto[200];   //[nPhoton]
   Bool_t          Photon_hasConversionTracks[200];   //[nPhoton]
   Bool_t          Photon_isScEtaEB[200];   //[nPhoton]
   Bool_t          Photon_isScEtaEE[200];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[200];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[200];   //[nPhoton]
   Bool_t          Photon_pixelSeed[200];   //[nPhoton]
   UChar_t         Photon_seedGain[200];   //[nPhoton]
   Short_t         Photon_electronIdx[200];   //[nPhoton]
   Short_t         Photon_jetIdx[200];   //[nPhoton]
   Short_t         Photon_seediEtaOriX[200];   //[nPhoton]
   Short_t         Photon_seediPhiOriY[200];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[200];   //[nPhoton]
   Float_t         Photon_ecalPFClusterIso[200];   //[nPhoton]
   Float_t         Photon_energyErr[200];   //[nPhoton]
   Float_t         Photon_energyRaw[200];   //[nPhoton]
   Float_t         Photon_esEffSigmaRR[200];   //[nPhoton]
   Float_t         Photon_esEnergyOverRawE[200];   //[nPhoton]
   Float_t         Photon_eta[200];   //[nPhoton]
   Float_t         Photon_etaWidth[200];   //[nPhoton]
   Float_t         Photon_haloTaggerMVAVal[200];   //[nPhoton]
   Float_t         Photon_hcalPFClusterIso[200];   //[nPhoton]
   Float_t         Photon_hoe[200];   //[nPhoton]
   Float_t         Photon_hoe_PUcorr[200];   //[nPhoton]
   Float_t         Photon_hoe_Tower[200];   //[nPhoton]
   Float_t         Photon_mvaID[200];   //[nPhoton]
   Float_t         Photon_pfChargedIso[200];   //[nPhoton]
   Float_t         Photon_pfChargedIsoPFPV[200];   //[nPhoton]
   Float_t         Photon_pfChargedIsoWorstVtx[200];   //[nPhoton]
   Float_t         Photon_pfPhoIso03[200];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all_quadratic[200];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg_quadratic[200];   //[nPhoton]
   Float_t         Photon_phi[200];   //[nPhoton]
   Float_t         Photon_phiWidth[200];   //[nPhoton]
   Float_t         Photon_pt[200];   //[nPhoton]
   Float_t         Photon_r9[200];   //[nPhoton]
   Float_t         Photon_s4[200];   //[nPhoton]
   Float_t         Photon_sieie[200];   //[nPhoton]
   Float_t         Photon_sieip[200];   //[nPhoton]
   Float_t         Photon_sipip[200];   //[nPhoton]
   Float_t         Photon_superclusterEta[200];   //[nPhoton]
   Float_t         Photon_trkSumPtHollowConeDR03[200];   //[nPhoton]
   Float_t         Photon_trkSumPtSolidConeDR04[200];   //[nPhoton]
   Float_t         Photon_x_calo[200];   //[nPhoton]
   Float_t         Photon_y_calo[200];   //[nPhoton]
   Float_t         Photon_z_calo[200];   //[nPhoton]
   Int_t           nPPSLocalTrack;
   Int_t           PPSLocalTrack_multiRPProtonIdx[200];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_singleRPProtonIdx[200];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_decRPId[200];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_rpType[200];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_x[200];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_y[200];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_time[200];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_timeUnc[200];   //[nPPSLocalTrack]
   ...
   Int_t           nPVBS;
   Float_t         PVBS_chi2[200];   //[nPVBS]
   Float_t         PVBS_cov00[200];   //[nPVBS]
   Float_t         PVBS_cov10[200];   //[nPVBS]
   Float_t         PVBS_cov11[200];   //[nPVBS]
   Float_t         PVBS_cov20[200];   //[nPVBS]
   Float_t         PVBS_cov21[200];   //[nPVBS]
   Float_t         PVBS_cov22[200];   //[nPVBS]
   Float_t         PVBS_x[200];   //[nPVBS]
   Float_t         PVBS_y[200];   //[nPVBS]
   Float_t         PVBS_z[200];   //[nPVBS]
   ...
   Float_t         SoftActivityJet_eta[200];   //[nSoftActivityJet]
   Float_t         SoftActivityJet_phi[200];   //[nSoftActivityJet]
   Float_t         SoftActivityJet_pt[200];   //[nSoftActivityJet]
   ...
   Short_t         Proton_singleRP_decRPId[200];   //[nProton_singleRP]
   Float_t         Proton_singleRP_thetaY[200];   //[nProton_singleRP]
   Float_t         Proton_singleRP_xi[200];   //[nProton_singleRP]
   Int_t           nSubJet;
   Float_t         SubJet_area[200];   //[nSubJet]
   Float_t         SubJet_btagDeepB[200];   //[nSubJet]
   Float_t         SubJet_eta[200];   //[nSubJet]
   Float_t         SubJet_mass[200];   //[nSubJet]
   Float_t         SubJet_n2b1[200];   //[nSubJet]
   Float_t         SubJet_n3b1[200];   //[nSubJet]
   Float_t         SubJet_phi[200];   //[nSubJet]
   Float_t         SubJet_pt[200];   //[nSubJet]
   Float_t         SubJet_rawFactor[200];   //[nSubJet]
   Float_t         SubJet_tau1[200];   //[nSubJet]
   Float_t         SubJet_tau2[200];   //[nSubJet]
   Float_t         SubJet_tau3[200];   //[nSubJet]
   Float_t         SubJet_tau4[200];   //[nSubJet]
   Int_t           nTauProd;
   Short_t         TauProd_tauIdx[200];   //[nTauProd]
   Int_t           TauProd_pdgId[200];   //[nTauProd]
   Float_t         TauProd_eta[200];   //[nTauProd]
   Float_t         TauProd_phi[200];   //[nTauProd]
   Float_t         TauProd_pt[200];   //[nTauProd]
   Int_t           nTau;
   UChar_t         Tau_decayMode[200];   //[nTau]
   Bool_t          Tau_idAntiEleDeadECal[200];   //[nTau]
   UChar_t         Tau_idAntiMu[200];   //[nTau]
   Bool_t          Tau_idDecayModeNewDMs[200];   //[nTau]
   Bool_t          Tau_idDecayModeOldDMs[200];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSe[200];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSjet[200];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSmu[200];   //[nTau]
   UChar_t         Tau_idDeepTau2018v2p5VSe[200];   //[nTau]
   UChar_t         Tau_idDeepTau2018v2p5VSjet[200];   //[nTau]
   UChar_t         Tau_idDeepTau2018v2p5VSmu[200];   //[nTau]
   UChar_t         Tau_nSVs[200];   //[nTau]
   Short_t         Tau_charge[200];   //[nTau]
   Short_t         Tau_decayModePNet[200];   //[nTau]
   Short_t         Tau_decayModeUParT[200];   //[nTau]
   Short_t         Tau_eleIdx[200];   //[nTau]
   Short_t         Tau_jetIdx[200];   //[nTau]
   Short_t         Tau_muIdx[200];   //[nTau]
   Short_t         Tau_svIdx1[200];   //[nTau]
   Short_t         Tau_svIdx2[200];   //[nTau]
   Float_t         Tau_chargedIso[200];   //[nTau]
   Float_t         Tau_dxy[200];   //[nTau]
   Float_t         Tau_dz[200];   //[nTau]
   Float_t         Tau_eta[200];   //[nTau]
   Float_t         Tau_leadTkDeltaEta[200];   //[nTau]
   Float_t         Tau_leadTkDeltaPhi[200];   //[nTau]
   Float_t         Tau_leadTkPtOverTauPt[200];   //[nTau]
   Float_t         Tau_mass[200];   //[nTau]
   Float_t         Tau_neutralIso[200];   //[nTau]
   Float_t         Tau_phi[200];   //[nTau]
   Float_t         Tau_photonsOutsideSignalCone[200];   //[nTau]
   Float_t         Tau_probDM0PNet[200];   //[nTau]
   Float_t         Tau_probDM0UParT[200];   //[nTau]
   Float_t         Tau_probDM10PNet[200];   //[nTau]
   Float_t         Tau_probDM10UParT[200];   //[nTau]
   Float_t         Tau_probDM11PNet[200];   //[nTau]
   Float_t         Tau_probDM11UParT[200];   //[nTau]
   Float_t         Tau_probDM1PNet[200];   //[nTau]
   Float_t         Tau_probDM1UParT[200];   //[nTau]
   Float_t         Tau_probDM2PNet[200];   //[nTau]
   Float_t         Tau_probDM2UParT[200];   //[nTau]
   Float_t         Tau_pt[200];   //[nTau]
   Float_t         Tau_ptCorrPNet[200];   //[nTau]
   Float_t         Tau_ptCorrUParT[200];   //[nTau]
   Float_t         Tau_puCorr[200];   //[nTau]
   Float_t         Tau_qConfPNet[200];   //[nTau]
   Float_t         Tau_qConfUParT[200];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSe[200];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSjet[200];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSmu[200];   //[nTau]
   Float_t         Tau_rawDeepTau2018v2p5VSe[200];   //[nTau]
   Float_t         Tau_rawDeepTau2018v2p5VSjet[200];   //[nTau]
   Float_t         Tau_rawDeepTau2018v2p5VSmu[200];   //[nTau]
   Float_t         Tau_rawIso[200];   //[nTau]
   Float_t         Tau_rawIsodR03[200];   //[nTau]
   Float_t         Tau_rawPNetVSe[200];   //[nTau]
   Float_t         Tau_rawPNetVSjet[200];   //[nTau]
   Float_t         Tau_rawPNetVSmu[200];   //[nTau]
   Float_t         Tau_rawUParTVSe[200];   //[nTau]
   Float_t         Tau_rawUParTVSjet[200];   //[nTau]
   Float_t         Tau_rawUParTVSmu[200];   //[nTau]
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[102];   //[nTrigObj]
   UShort_t        TrigObj_id[102];   //[nTrigObj]
   Int_t           TrigObj_l1iso[102];   //[nTrigObj]
   Int_t           TrigObj_filterBits[102];   //[nTrigObj]
   Float_t         TrigObj_pt[102];   //[nTrigObj]
   Float_t         TrigObj_eta[102];   //[nTrigObj]
   Float_t         TrigObj_phi[102];   //[nTrigObj]
   Float_t         TrigObj_l1pt[102];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[102];   //[nTrigObj]
   Float_t         TrigObj_l2pt[102];   //[nTrigObj]
   Float_t         TrkMET_phi;
   Float_t         TrkMET_pt;
   Float_t         TrkMET_sumEt;
   Int_t           nOtherPV;
   Float_t         OtherPV_z[200];   //[nOtherPV]
   Float_t         OtherPV_score[200];   //[nOtherPV]
   UChar_t         PV_npvs;
   UChar_t         PV_npvsGood;
   Float_t         PV_ndof;
   Float_t         PV_x;
   ...
   Float_t         PV_sumpy;
   Int_t           nSV;
   Short_t         SV_charge[200];   //[nSV]
   Float_t         SV_dlen[200];   //[nSV]
   Float_t         SV_dlenSig[200];   //[nSV]
   Float_t         SV_dxy[200];   //[nSV]
   Float_t         SV_dxySig[200];   //[nSV]
   Float_t         SV_pAngle[200];   //[nSV]
   Float_t         Electron_IPx[200];   //[nElectron]
   Float_t         Electron_IPy[200];   //[nElectron]
   Float_t         Electron_IPz[200];   //[nElectron]
   Float_t         Electron_ipLengthSig[200];   //[nElectron]
   Float_t         Muon_IPx[200];   //[nMuon]
   Float_t         Muon_IPy[200];   //[nMuon]
   Float_t         Muon_IPz[200];   //[nMuon]
   Float_t         Muon_ipLengthSig[200];   //[nMuon]
   UChar_t         SV_ntracks[200];   //[nSV]
   Float_t         SV_chi2[200];   //[nSV]
   Float_t         SV_eta[200];   //[nSV]
   Float_t         SV_mass[200];   //[nSV]
   Float_t         SV_ndof[200];   //[nSV]
   Float_t         SV_phi[200];   //[nSV]
   Float_t         SV_pt[200];   //[nSV]
   Float_t         SV_x[200];   //[nSV]
   Float_t         SV_y[200];   //[nSV]
   Float_t         SV_z[200];   //[nSV]
   Bool_t          Tau_hasRefitSV[200];   //[nTau]
   Float_t         Tau_IPx[200];   //[nTau]
   Float_t         Tau_IPy[200];   //[nTau]
   Float_t         Tau_IPz[200];   //[nTau]
   Float_t         Tau_ipLengthSig[200];   //[nTau]
   Float_t         Tau_refitSVchi2[200];   //[nTau]
   Float_t         Tau_refitSVcov00[200];   //[nTau]
   Float_t         Tau_refitSVcov10[200];   //[nTau]
   Float_t         Tau_refitSVcov11[200];   //[nTau]
   Float_t         Tau_refitSVcov20[200];   //[nTau]
   Float_t         Tau_refitSVcov21[200];   //[nTau]
   Float_t         Tau_refitSVcov22[200];   //[nTau]
   Float_t         Tau_refitSVx[200];   //[nTau]
   Float_t         Tau_refitSVy[200];   //[nTau]
   Float_t         Tau_refitSVz[200];   //[nTau]
   Bool_t          L1Reco_step;
...
#ifdef WMassRun3_cxx
WMassRun3::WMassRun3(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("090b75df-297c-43a4-8178-5cbfd06387bc.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("090b75df-297c-43a4-8178-5cbfd06387bc.root");
      }
...
Int_t WMassRun3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WMassRun3::LoadTree(Long64_t entry)
{
...
void WMassRun3::Init(TTree *tree)
{
...
void WMassRun3::Show(Long64_t entry)
{
...
Int_t WMassRun3::Cut(Long64_t entry)
{
