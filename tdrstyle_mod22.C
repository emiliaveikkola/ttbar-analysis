...
#include "TCanvas.h"
#include "TH1D.h"// Collect all the #includes here
#ifndef __TDRSTYLEMOD15__
#define __TDRSTYLEMOD15__
#include "TROOT.h"
#include "TGraph.h"
...
TString lumi_136TeV = "2024";//"7.67 fb^{-1}";
TString lumi_13TeV = "137 fb^{-1}";
TString lumi_13TeV_17 = "41.5 fb^{-1}";
TString lumi_13TeV_18 = "59.7 fb^{-1}";
TString lumi_13TeV_1718 = "101 fb^{-1}";
TString lumi_13TeV_2025 = "_ fb^{-1}";
...
{            
  ...
  if( iPeriod==1 )
    ...
    {
      lumiText += lumi_13TeV;
      lumiText += " (Run2 Legacy, 13 TeV)";
    }
  else if ( iPeriod==2025 )
    {
      lumiText += lumi_13TeV_2025;
      lumiText += " (2025, 13.6 TeV)";
    }
  else if ( iPeriod==1718 )
    {
      lumiText += lumi_13TeV_1718;
      lumiText += " (Run2 Legacy, 13 TeV)";
    }
  else if ( iPeriod==17 )
    {
      lumiText += lumi_13TeV_17;
      lumiText += " (Run2 Legacy, 13 TeV)";
    }
  else if ( iPeriod==18 )
    {
